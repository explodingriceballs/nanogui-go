...
import (
	"fmt"
	"github.com/explodingriceballs/nanogui-go"
	"github.com/explodingriceballs/nanogui-go/example/demo"
...
func (a *Application) init() {
	...
	a.screen.NVGContext().CreateFont("japanese", "example/font/GenShinGothic-P-Regular.ttf")

	demo.ButtonDemo(a.screen)
	images := loadImageDirectory(a.screen.NVGContext(), "example/icons")
